...
namespace practica {
    ...
    public partial class practikaDataSet : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UserRow AddUserRow(string FIO, string role, string login, string password) {
...
namespace practica.practikaDataSetTableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[User] WHERE (([id_user] = @Original_id_user) AND ([FIO] = @Ori" +
                "ginal_FIO) AND ([role] = @Original_role) AND ([login] = @Original_login) AND ([p" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[User] ([FIO], [role], [login], [password]) VALUES (@FIO, @role" +
                ", @login, @password);\r\nSELECT id_user, FIO, role, login, password FROM [User] WH" +
                "ERE (id_user = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[User] SET [FIO] = @FIO, [role] = @role, [login] = @login, [password] = @password WHERE (([id_user] = @Original_id_user) AND ([FIO] = @Original_FIO) AND ([role] = @Original_role) AND ([login] = @Original_login) AND ([password] = @Original_password));
SELECT id_user, FIO, role, login, password FROM [User] WHERE (id_user = @id_user)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::practica.Properties.Settings.Default.practikaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id_user, FIO, role, login, password FROM dbo.[User]";
        ...
        public virtual int Fill(practikaDataSet.UserDataTable dataTable) {
        ...
        public virtual practikaDataSet.UserDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            practikaDataSet.UserDataTable dataTable = new practikaDataSet.UserDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(practikaDataSet.UserDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id_user, string Original_FIO, string Original_role, string Original_login, string Original_password) {
        ...
        public virtual int Insert(string FIO, string role, string login, string password) {
            if ((FIO == null)) {
        ...
        public virtual int Update(string FIO, string role, string login, string password, int Original_id_user, string Original_FIO, string Original_role, string Original_login, string Original_password, int id_user) {
            if ((FIO == null)) {
                throw new global::System.ArgumentNullException("FIO");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FIO, string role, string login, string password, int Original_id_user, string Original_FIO, string Original_role, string Original_login, string Original_password) {
            return this.Update(FIO, role, login, password, Original_id_user, Original_FIO, Original_role, Original_login, Original_password, Original_id_user);
        }
    }
